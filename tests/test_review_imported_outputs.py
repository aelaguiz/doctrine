...
class ReviewImportedOutputsTests(unittest.TestCase):
    ...
    def _shared_review_flow_files(self, *, output_in_sibling_file: bool) -> dict[str, str]:
        review_output = """
        ...
        """
        if output_in_sibling_file:
            return {
                "prompts/shared/review/AGENTS.prompt": """
                workflow SharedReviewScaffold: "Shared Review Scaffold"
                    "Keep the review flow anchored at one boundary root."
                """,
                "prompts/shared/review/comment.prompt": review_output,
            }
        return {
            "prompts/shared/review/AGENTS.prompt": review_output,
        }
    ...
    def test_imported_review_comment_output_can_bind_local_routed_agents(self) -> None:
        agent = self._compile_agent(
            ...
            extra_files=self._shared_review_flow_files(output_in_sibling_file=True),
        )
