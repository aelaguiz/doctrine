...
- [79_final_output_json_schema](../examples/79_final_output_json_schema/prompts/AGENTS.prompt)
- [104_review_final_output_json_schema_blocked_control_ready](../examples/104_review_final_output_json_schema_blocked_control_ready/prompts/AGENTS.prompt)
- [105_review_split_final_output_json_schema_control_ready](../examples/105_review_split_final_output_json_schema_control_ready/prompts/AGENTS.prompt)
- [106_review_split_final_output_json_schema_partial](../examples/106_review_split_final_output_json_schema_partial/prompts/AGENTS.prompt)
...
- [85_review_split_final_output_json_schema](../examples/85_review_split_final_output_json_schema/prompts/AGENTS.prompt)
- [106_review_split_final_output_json_schema_partial](../examples/106_review_split_final_output_json_schema_partial/prompts/AGENTS.prompt)
...
- Output contracts and final answers:
  ...
  [79](../examples/79_final_output_json_schema/prompts/AGENTS.prompt),
  [104](../examples/104_review_final_output_json_schema_blocked_control_ready/prompts/AGENTS.prompt),
  [105](../examples/105_review_split_final_output_json_schema_control_ready/prompts/AGENTS.prompt),
  [106](../examples/106_review_split_final_output_json_schema_partial/prompts/AGENTS.prompt)
- Skill packages:
