...
.PHONY: help setup test tests check verify verify-examples verify-diagnostics build-dist verify-skill-install verify-package verify-package-wheel verify-package-sdist release-prepare release-tag release-draft release-publish vscode-tests vscode-package
