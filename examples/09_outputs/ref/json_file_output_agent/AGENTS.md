...
| Support Surface | Path | Use When |
| --- | --- | --- |
| `GUIDED_WALKTHROUGH_LENGTH_REPORT.md` | `lesson_root/GUIDED_WALKTHROUGH_LENGTH_REPORT.md` | Guided-walkthrough pacing is in scope. |
